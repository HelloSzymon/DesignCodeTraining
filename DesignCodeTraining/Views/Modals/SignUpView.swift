        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            TextField("Email", text: $email)
                .inputStyle(icon: "mail")
                   ...
                   .shadow(color: focusedField == .email ? .primary : .clear, radius: 10, x: 0, y: 3)
                   .overlay(geometry)
            ...
            SecureField("Password", text: $password)
                ...
                .shadow(color: focusedField == .password ? .primary : .clear, radius: 10, x: 0, y: 3)
                .overlay(geometry)
            ...
            Group {
                ...
                + Text(", you agree to our **Terms of service** and **[GitHub](https://github.com/HelloSzymon)**")
